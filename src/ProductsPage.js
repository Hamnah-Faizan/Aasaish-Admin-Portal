...
//   try {
//     const { data: vendorDetails } = await axios.get(`${BASE_URL}/User/vendors`);
//     const storeId = vendorDetails.stores && vendorDetails.stores.length > 0 ? vendorDetails.stores[0]._id : null;

//     console.log("brand:" + vendorDetails.brand._id);
...
//     enqueueSnackbar('Error fetching vendor details', { variant: 'error' });
//   }
// };
...
//               Manage Collections
//             </MenuItem>
//             <MenuItem onClick={fetchProducts}>
//               Fetch Product Api
//             </MenuItem>
//           </Menu>
